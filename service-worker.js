const l = [
  ...
  "/_app/immutable/start-a7dad3fc.js",
  ...
  "/_app/immutable/chunks/2-d5ef5b18.js",
  "/_app/immutable/chunks/7-f0e2f940.js",
  "/_app/immutable/modules/pages/_page.js-c0185d73.js",
  "/_app/immutable/modules/pages/_entry_/_layout.js-68c7d6da.js",
  ...
  "/_app/immutable/chunks/_layout-0c99bfcd.js",
  ...
  "/manifest.json",
  "/preview.jpg"
], d = "1709819265541", b = "24", u = "Berlin Blockchain Week 2024", h = "https://duplicity6-sulfur-objet0-air1.protocol.berlin/24", f = "https://outright6-sear-8gusto-atrium.protocol.berlin/24", g = "https://github.com/blockchainweek/data/tree/main/data/24", y = [
  {
    id: "cbase",
...
`,
    ...
    links: {
      ...
      telegram: "https://matrix.to/#/%23ethberlin:dod.ngo"
    },
    segments: [
      {
        date: "2024-05-24",
  ...
  },
  {
    ...
    org: "Web3Privacy now",
    dri: "burningtree",
    poc: "https://matrix.to/#/#web3privacy:matrix.org",
    date: "2024-05-22",
    days: 1,
    times: "15:00-21:00",
    venues: [
...
], T = "2024-02-12T17:14:52.327Z", B = "v24.1.4", r = {
  id: b,
  name: u,
  dataUrl: h,
  exploreUrl: f,
...
for (const e in c.collections)
  c.collections[e].virtual || n.push(...r[e].map((t) => t.logo || t.photoUrl || t.photo).filter((t) => t));
for (const e of r.events)
  e.speakers && n.push(...e.speakers.map((t) => t.photoUrl).filter((t) => t));
const p = [
  ...l,
  // the app itself
  ...m,
...
self.addEventListener("fetch", (e) => {
  ...
  async function t() {
    ...
    try {
      ...
      return o.status === 200 && s.put(e.request, o.clone()), o;
    } catch {
      return s.match(e.request);
    }
  }
