const l = [
  ...
  "/_app/immutable/modules/pages/_entry_/_layout.js-598eef56.js",
  ...
  "/_app/immutable/chunks/2-b31f21a4.js",
  ...
  "/manifest.json",
  "/preview.jpg"
], d = "1710967652173", b = "24", u = "Berlin Blockchain Week 2024", h = "https://duplicity6-sulfur-objet0-air1.protocol.berlin/24", f = "https://outright6-sear-8gusto-atrium.protocol.berlin/24", g = "https://github.com/blockchainweek/data/tree/main/data/24", y = [
  {
    id: "factory",
...
], j = "2024-03-12T11:02:29.036Z", B = "v24.1.5", c = {
  id: b,
  name: u,
  dataUrl: h,
  exploreUrl: f,
...
for (const e in r.collections)
  r.collections[e].virtual || n.push(...c[e].map((t) => t.logo || t.photoUrl || t.photo).filter((t) => t));
...
self.addEventListener("install", (e) => {
  async function t() {
    await (await caches.open(o)).addAll(p);
  }
  e.waitUntil(t());
});
...
self.addEventListener("fetch", (e) => {
  if (e.request.method !== "GET")
    return;
  async function t() {
    const s = new URL(e.request.url), a = await caches.open(o);
